...
# DB파일 조회(없으면 새로 생성)
conn = sqlite3.connect("D:/developing/fastcampus/python-study-basic/resource/database.db") # 본인 DB 경로
...
# Dump 출력
with conn:
    with open("D:/developing/fastcampus/python-study-basic/resource/dump.sql","w") as f:
